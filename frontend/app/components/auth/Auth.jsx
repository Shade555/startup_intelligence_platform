...
export default function Auth() {
  ...
  const handleGithubLogin = async () => {
    ...
    try {
      ...
      setError(err.message || 'An error occurred with GitHub login');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="auth-container">
      ...
      <div className="auth-card" key={isSignUp ? 'signup' : 'signin'}>
        ...
        <div className="social-login">
          ...
          <button type="button" className="social-btn github-btn" disabled={loading} onClick={handleGithubLogin}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
